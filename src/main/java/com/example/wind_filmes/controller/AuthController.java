...
import com.example.wind_filmes.security.JwtService; // ⬅️ novo import
...
@RestController
@RequestMapping("/api/auth") // ⬅️ alterado para /api/auth
...
public class AuthController {
    ...
    private final JwtService jwtService; // ⬅️ novo
    ...
    public ResponseEntity<LoginResponse> login(@Valid @RequestBody LoginRequest request) {
        ...
        // gera token e atualiza last_login
